    ...
    if len(nd) > 1:
        ...
        for cN in combN:
            ...
            for cV2 in combV2:
                ...
                pasp3 += np.prod(nd[cV2] * t2[cV2] * v2[cV2]) * np.prod(
                    nd[cV01] * t2[cV01] * (v0[cV01] + v1[cV01])) * np.prod(nn[cNN])
            p0 += pasp0
            p3 += pasp3
            p2 += pas - pasp3 - pasp0
            if verb:
            ...
            for cT2 in combT2:
                ...
                pT01 = calcCTFleischnerProb_Mixed(v0[cT01], v1[cT01], v2[cT01], t0[cT01], t1[cT01], t2[cT01],
                                                  'allnonsolid')
